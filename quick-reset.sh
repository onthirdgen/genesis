#!/bin/bash
# quick-reset.sh - Complete data reset for Call Auditing Platform
...
echo ""
echo "[4/10] Waiting for services to be ready (30 seconds)..."
sleep 30
...
check_health "consumer-service" "http://localhost:8088/api/publish/health"
...
echo "  5. Test with: curl http://localhost:8081/actuator/health"
echo ""
